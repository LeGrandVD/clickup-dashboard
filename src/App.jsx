...
const App = () => {
  ...
  // handleAuth removed - using manual token entry
  // useEffect(() => { ... }, []);
  ...
  const weeklyTargetCalc = settings.weeklyTarget;
  const weeklyProgress = Math.min((data.weeklyPoints / weeklyTargetCalc) * 100, 100);
  const weeklyStrokeDashoffset = 440 - (440 * weeklyProgress) / 100;
    ...
    return (
      <div className="dashboard-container">
        ...
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
          <div>
            <div className="loading-skeleton skeleton-text" style={{ width: '150px', height: '1.5rem', marginBottom: '0.25rem' }}></div>
          </div>
        ...
        {/* Initial Card Skeleton */}
        <div className="glass-card" style={{ textAlign: 'center', height: '320px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          <div className="loading-skeleton skeleton-text" style={{ width: '120px', marginBottom: '1.5rem' }}></div>
          <div className="loading-skeleton skeleton-circle" style={{ width: '140px', height: '140px', border: '12px solid rgba(255,255,255,0.05)' }}></div>
          <div className="loading-skeleton skeleton-text" style={{ width: '80px', height: '2rem', marginTop: '1rem' }}></div>
          <div className="loading-skeleton skeleton-text" style={{ width: '100px', height: '1rem' }}></div>
        </div>
        ...
        <div className="stat-grid">
           {[1, 2].map(i => (
             <div key={i} className="glass-card stat-card">
               <div className="loading-skeleton skeleton-block" style={{ width: '24px', height: '24px', marginBottom: '0.5rem' }}></div>
               <div className="loading-skeleton skeleton-text" style={{ width: '40px', height: '1.25rem' }}></div>
               <div className="loading-skeleton skeleton-text" style={{ width: '80px', height: '0.75rem' }}></div>
             </div>
           ))}
        </div>
        ...
        <div className="glass-card" style={{ padding: '1rem' }}>
          <div className="loading-skeleton skeleton-text" style={{ width: '180px', height: '1.125rem', marginBottom: '1.5rem' }}></div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            {[1, 2, 3].map(i => (
              <div key={i} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.75rem' }}>
                 <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center', width: '100%' }}>
                   <div className="loading-skeleton skeleton-circle" style={{ width: '18px', height: '18px', flexShrink: 0 }}></div>
                   <div style={{ width: '100%' }}>
                     <div className="loading-skeleton skeleton-text" style={{ width: '60%', height: '0.875rem', marginBottom: '0.25rem' }}></div>
                     <div className="loading-skeleton skeleton-text" style={{ width: '30%', height: '0.625rem' }}></div>
                   </div>
                 </div>
                 <div className="loading-skeleton skeleton-block" style={{ width: '40px', height: '20px' }}></div>
              </div>
            ))}
          </div>
        </div>
